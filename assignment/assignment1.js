...
display.innerHTML = quotes[0].quote;
author.innerHTML = quotes[0].author;
currentPosition = 1;
nextBtn.addEventListener("click", function () {
  if (currentPosition < quotes.length) {
    console.log(currentPosition);
    display.innerHTML = quotes[currentPosition].quote;

    author.innerHTML = quotes[currentPosition].author;
    currentPosition++;
  }
});
